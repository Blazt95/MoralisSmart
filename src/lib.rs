...
#[derive(Debug)]
pub struct MoralisSmartProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MoralisSmartProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MoralisSmart processing");
    
    let mut processor = MoralisSmartProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MoralisSmartProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MoralisSmartProcessor::new(false);
